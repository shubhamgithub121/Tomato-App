        ...
        <div className={signupCss.modal}>
            ...
            <div className={signupCss.lgBox}>
                ...
                <span className={signupCss.termsTxt}>
                    ...
                    <span>
                        I agree to Tomato's <a href="" className={signupCss.termaAnchor}>Terms of Service, Privacy Policy</a> and <a href="" className={signupCss.termaAnchor}>Content Policies</a>
                    </span>
                </span>
            ...
            <div className={signupCss.newToTomato}>Already have an account? <div className={signupCss.createAcc} onClick={() => setAuth({ closed: false, login: true, signup: false })} >Log in</div></div>
        </div>
    </div>
