...
let Login = ({ setAuth, setLoggedIn }) => {
    ...
    let loginDiv = !otpModal ? <div className={loginCss.outerDiv}>
        <div className={loginCss.modal}>
            ...
            <div className={loginCss.newToTomato}>New to Tomato? <div className={loginCss.createAcc} onClick={() => setAuth({ closed: false, login: false, signup: true })}>Create Account</div></div>
        </div>
